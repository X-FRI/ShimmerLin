...
// import * as shimmerLinData from "./seed-data";
import { PrismaClient } from "../generated/shimmer-lin";
import { DBClient } from "./shimmer-lin-db-client";
...
async function main() {
  ...
  // E.g: await dbClient.seedUsers(shimmerLinData.usersRaw as unknown as User[]);
